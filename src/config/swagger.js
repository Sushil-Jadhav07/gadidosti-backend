      ...
      schemas: {
        ...
        ClientRegisterRequest: {
          ...
          properties: {
            ...
            email:    { type: 'string', format: 'email', example: 'rajesh@example.com',  nullable: true },
            password: { type: 'string', format: 'password', example: 'Client@123',       description: 'Min 8 chars with uppercase, lowercase and a number' },
        ...
        BrokerRegisterRequest: {
          ...
          properties: {
            ...
            password: { type: 'string', format: 'password', example: 'Broker@123',         description: 'Min 8 chars with uppercase, lowercase and a number' },
        ...
        DriverRegisterRequest: {
          ...
          properties: {
            ...
            password: { type: 'string', format: 'password', example: 'Driver@123',         description: 'Min 8 chars with uppercase, lowercase and a number' },
        ...
        ResetPasswordRequest: {
          ...
          properties: {
            ...
            new_password: { type: 'string', format: 'password', example: 'NewPass@123', description: 'Min 8 chars with uppercase, lowercase and a number' },
          },
        },
