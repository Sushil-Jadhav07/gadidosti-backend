...
const runMigrations = async (client) => {
  try {
    ...
    // ── MONTHLY VEHICLE HIRING — ENQUIRY ONLY (mirrors db/50monthly_hiring.sql) ──
    ...
    // auto-matches the two — admin sees both lists in full and follows up manually (see
    // updateMonthlyEnquiryStatus for the only state admin tracks: open/contacted/closed).
    await client.query(`
